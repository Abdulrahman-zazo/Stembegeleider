  ...
  return [
        ...
        questions: [
          {
            ...
            image:"https://res.cloudinary.com/dmn6uzy82/image/upload/v1771899141/q1_rzvx4g.png",
            options: [
    ...
    },
    {
      ...
      description: t('sections.naarStembureau.description'),
         ...
         image: 'https://res.cloudinary.com/dmn6uzy82/image/upload/v1771899141/s2_mg26uu.png',
      ...
      doeType: 'dragdrop',
      doeContent: {
        title: t('sections.naarStembureau.doe.title'),
        items: [
          { id: 'stempas', label: t('sections.naarStembureau.doe.items.stempas'), correct: true },
          { id: 'paspoort', label: t('sections.naarStembureau.doe.items.paspoort'), correct: true },
          { id: 'rijbewijs', label: t('sections.naarStembureau.doe.items.rijbewijs'), correct: true },
          { id: 'kandidatenlijst', label: t('sections.naarStembureau.doe.items.kandidatenlijst'), correct: false },
          { id: 'appel', label: t('sections.naarStembureau.doe.items.appel'), correct: false },
          { id: 'lippenstift', label: t('sections.naarStembureau.doe.items.lippenstift'), correct: false },
          { id: 'poster', label: t('sections.naarStembureau.doe.items.poster'), correct: false },
        ],
      ...
      imageButtons: [
        {
          ...
          modalTitle: t('sections.naarStembureau.buttons.identiteitsbewijs.title'),
          modalContent: t('sections.naarStembureau.buttons.identiteitsbewijs.content'),
        },
        {
          id: 'kandidatenlijst-button',
          label: t('sections.naarStembureau.buttons.kandidatenlijst.label'),
          modalTitle: t('sections.naarStembureau.buttons.kandidatenlijst.title'),
          modalContent: t('sections.naarStembureau.buttons.kandidatenlijst.content'),
        },
        {
          id: 'kind-mee',
        ...
        },
        {
          ...
          label: t('sections.naarStembureau.buttons.vreemdelingendocument.label'),
          modalTitle: t('sections.naarStembureau.buttons.vreemdelingendocument.title'),
          modalContent: t('sections.naarStembureau.buttons.vreemdelingendocument.content'),
        },
        {
          id: 'in-het-kort-2',
    ...
    },
    {
      ...
      description: t('sections.opStembureau.description'),
         image: 'https://res.cloudinary.com/dmn6uzy82/image/upload/v1771899146/s3_ez0vrr.png',
      ...
      imageButtons: [
        {
          ...
          modalContent: t('sections.opStembureau.buttons.ikBenGemachtigd.content'),
        },
        {
          id: 'stempas-gescand',
          ...
          modalContent: t('sections.opStembureau.buttons.stempasGescand.content'),
        },
        {
          id: 'op-wie-stem-ik',
    ...
    },
    {
      ...
      description: t('sections.inStemhokje.description'),
           image: 'https://res.cloudinary.com/dmn6uzy82/image/upload/v1771899142/s4_id9xoq.png',
        ...
        questions: [
          {
            ...
            image:"https://res.cloudinary.com/dmn6uzy82/image/upload/v1771899142/yn01_hmtmao.png",
            options: [t('sections.inStemhokje.doe.questions.0.options.0'), t('sections.inStemhokje.doe.questions.0.options.1')],
            correct: 1,
            explanation: t('sections.inStemhokje.doe.questions.0.explanation'),
          },
          {
            question: t('sections.inStemhokje.doe.questions.1.question'),
            image:"https://res.cloudinary.com/dmn6uzy82/image/upload/v1771899143/yn02_jeextx.png",

            options: [t('sections.inStemhokje.doe.questions.1.options.0'), t('sections.inStemhokje.doe.questions.1.options.1')],
            correct: 0,
            explanation: t('sections.inStemhokje.doe.questions.1.explanation'),
          },
          {
            question: t('sections.inStemhokje.doe.questions.2.question'),
            image:"https://res.cloudinary.com/dmn6uzy82/image/upload/v1771899141/yn03_pw9egc.png",

            options: [t('sections.inStemhokje.doe.questions.2.options.0'), t('sections.inStemhokje.doe.questions.2.options.1')],
            correct: 1,
            explanation: t('sections.inStemhokje.doe.questions.2.explanation'),
          },
          {
            question: t('sections.inStemhokje.doe.questions.3.question'),
            image:"https://res.cloudinary.com/dmn6uzy82/image/upload/v1771899141/yn04_rv07he.png",

            options: [t('sections.inStemhokje.doe.questions.3.options.0'), t('sections.inStemhokje.doe.questions.3.options.1')],
            correct: 1,
            explanation: t('sections.inStemhokje.doe.questions.3.explanation'),
          },
          {
            question: t('sections.inStemhokje.doe.questions.4.question'),
            image:"https://res.cloudinary.com/dmn6uzy82/image/upload/v1771899142/yn05_zjutjd.png",

            options: [t('sections.inStemhokje.doe.questions.4.options.0'), t('sections.inStemhokje.doe.questions.4.options.1')],
            correct: 1,
      ...
      imageButtons: [
        {
          ...
          modalContent: t('sections.inStemhokje.buttons.verkeerdIngevuld.content'),
        },
        {
          id: 'inkleuren-verplicht',
          label: t('sections.inStemhokje.buttons.inkleurenVerplicht.label'),
          modalTitle: t('sections.inStemhokje.buttons.inkleurenVerplicht.title'),
          modalContent: t('sections.inStemhokje.buttons.inkleurenVerplicht.content'),
        },
        {
          id: 'foto-maken',
    ...
    },
    {
      ...
      description: t('sections.bijStembus.description'),
            image: 'https://res.cloudinary.com/dmn6uzy82/image/upload/v1771899143/s5_eamtmw.png',
    ...
    },
    {
      ...
      description: t('sections.jeHebtGestemd.description'),
              image: 'https://res.cloudinary.com/dmn6uzy82/image/upload/v1771899143/s6_t4dde2.png',
      ...
      imageButtons: [
        {
          ...
          modalContent: t('sections.jeHebtGestemd.buttons.stemmenTellen.content'),
        },
        {
          id: 'exitpoll',
